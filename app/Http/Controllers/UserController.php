...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $my_events = Event::where('user_id', $user_id)->get();
        return view('/user/profile', compact(['title', 'profilUser', 'my_events']));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('/user/profile', compact(['title', 'user', 'my_events']));
    }
