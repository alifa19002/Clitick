                ...
                {{-- <div class="card-body"> --}}
                  <div class="content mt-5" id="top-content">
                      <div>
                        ...
                        <img src="images/foto-profil.png" width="180px" style="float:left" alt="">
                        <h5 class="edit mt-5 mb-3">Hallo, </h5>
                        <p class="edit mb-2">You can fill this form to update your profile!</p>
                        <a class="btn btn-sm btn-primary mt-4" href="/editprofile">Edit Foto Profil</a>
                    </div>
                    <div class="row justify-content" id="bottom-content">
                          ...
                          <div class="box-login mt-3">
                            <h6>Nomor Telepon</h6>
                            <input type="tel" name="no_telp" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" placeholder="Nomor Telepon" required value="{{ old('no_telp') }}">
